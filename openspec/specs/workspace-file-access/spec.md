# workspace-file-access Specification

## Purpose
Define trusted workspace-scoped file access for ACP sessions, including client filesystem read capability, approval-free text reads inside the session workspace, and rejection of paths outside the trusted workspace boundary.
## Requirements
