...
## Purpose
Define how persisted ACP-backed agent sessions expose continuation state, restore through supported agent capabilities, and reconcile replayed history after backend restarts.
## Requirements
